...
exports.EcommWebElementActions = void 0;
...
class EcommWebElementActions {
     ...
     */
    static async navigateToUrl(url, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await driver.pause(waitTimeOut || constants_1.ETimeout.TIMEOUT_XXS);
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async clickElement(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async doubleClickElement(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
        await (await elementPath).waitForClickable({ timeout: waitTimeOut });
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async clearInputText(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async clearInputTextJS(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
        await (await elementPath).click();
     ...
     */
    static async inputText(elementPath, inputText, waitTimeOut = constants_1.ETimeout.TIMEOUT_L) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
        await expect(await elementPath).toBeDisplayed();
        await elementPath.clearValue();
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_L).
     */
    static async selectFromDropdown(elementPath, attributeName, attributeValue, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_L).
     */
    static async selectVisibleTextFromDropdown(elementPath, visibleText, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
     ...
     */
    static async getText(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async getTextAndCompareExactText(elementPath, expectedText, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
        await expect(await elementPath).toBeDisplayed();
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async getTextAndComparePartialText(elementPath, expectedText, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
        await expect(await elementPath).toBeDisplayed();
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async getAttributeAndVerifyExactText(elementPath, expectedText, attributeValue, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async verifyElementAttributeAndValue(elementPath, elementAttribute, expectedValue, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async waitUntilElementIsDisplayed(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
        await expect(await elementPath).toBeDisplayed();
    }
    /**
     ...
     */
    static async pauseOnElement(elementPath, waitTimeOut = constants_1.ETimeout.TIMEOUT_XXS) {
    ...
    static async randomEmailGenerator() {
        const cInstance = new chance_1.Chance();
     ...
     * @param waitTimeOut - The timeout for element display (default: ETimeout.TIMEOUT_S).
     */
    static async getCSSPropertyColorAndVerifyHexColor(elementPath, colorHexCode, waitTimeOut = constants_1.ETimeout.TIMEOUT_S) {
        await elementPath.waitForDisplayed({ timeout: waitTimeOut });
...
exports.EcommWebElementActions = EcommWebElementActions;
exports.default = EcommWebElementActions;
